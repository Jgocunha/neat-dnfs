...
namespace neat_dnfs
{
	SetupWindow::SetupWindow(const std::shared_ptr<Population>& population)
	...
	void SetupWindow::renderPopulationInfo()
	{
	...
	void SetupWindow::renderSolutionInfo()
	{
		static constexpr int columnWidth = 250;
        static constexpr int inputWidth = 150;
    ...
    void SetupWindow::renderPopulationMethods()
    {
   ...
   //         isInitialized = true;
    ...
    void SetupWindow::renderSolutionMethods()
	{
		//if (!population)
		//	return;
  ...
  //      }
    ...
    void SetupWindow::renderShowBestSolution()
    {
