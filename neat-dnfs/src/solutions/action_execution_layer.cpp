...
namespace neat_dnfs
{
	...
	void ActionExecutionSimulation::testPhenotype()
	{
		...
		static constexpr double wbehaviour = 1.f / 5.f;
		...
		static constexpr double wf4_1 = 0.20;
		static constexpr double wf4_2 = 0.60;
		static constexpr double wf4_3 = 0.10;
		static constexpr double wf4_4 = 0.10;

		parameters.fitness += wbehaviour * (wf4_1 * f4_1 + wf4_2 * f4_2 + wf4_3 * f4_3 + wf4_4 * f4_4);
