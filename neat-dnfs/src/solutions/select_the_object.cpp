...
namespace neat_dnfs
{
	...
	void SelectTheObject::testPhenotype()
	{
		...
		static constexpr double wf1		= 1 / 10.f; // multi bump sof
		static constexpr double wf2		= 1 / 10.f; // sof creates a selective single bump in taf
		//static constexpr double wf3		= 1 / 13.f; // lof single bump
		static constexpr double wf4		= 1 / 10.f; // lof pre-shapes taf
		static constexpr double wf5		= 1 / 10.f; // sof + hpf create a selective single bump in taf (pos. 20)
		static constexpr double wf6		= 1 / 10.f; // sof + hpf create a selective single bump in taf (pos. 80)
		...
		static constexpr double wf9		= 1 / 10.f; // lof + hpf create a single bump in taf
		static constexpr double wf10	= 1 / 10.f; // lof + sof + hpf create a selective single bump in taf (pos. 50)
		static constexpr double wf11	= 1 / 10.f; // 
		static constexpr double wf11_	= 1 / 10.f; //
		static constexpr double wf12	= 1 / 10.f; //
