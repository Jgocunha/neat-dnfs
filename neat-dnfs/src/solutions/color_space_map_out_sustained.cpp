...
namespace neat_dnfs
{
	...
	void ColorSpaceMapOutputSustainedSolution::testing()
	{
		...
		for (const auto& inputOutputBump : inputOutputBumps)
		{
			...
			const double f2 = oneBumpAtPositionWithAmplitudeAndWidth("nf 2", expectedOutput, 25.0, 25.0);
			...
			const double f4 = oneBumpAtPositionWithAmplitudeAndWidth("nf 2", expectedOutput, 10.0, 10.0);
			...
			static constexpr double wf0_1 = 0.00;
			static constexpr double wf0_2 = 0.00;
