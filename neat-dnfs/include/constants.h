...
namespace neat_dnfs
{
	...
	struct GaussKernelConstants
	{
		...
		static constexpr double ampMinVal = 5; // 0.5
		static constexpr double ampMaxVal = 20.0; // 8.0
		static constexpr double ampStep = 0.5; // 0.5

		static constexpr double ampGlobalMinVal = -2.0; // -0.5
	...
	struct MexicanHatKernelConstants
	{
		...
		static constexpr double ampGlobMin = -2.0; // -0.5
		...
		struct FieldGeneConstants
	{
		...
		static constexpr double mutateFieldGeneGaussKernelAmplitudeProbability			= 1.0f / 2.0f;
		static constexpr double mutateFieldGeneGaussKernelWidthProbability				= 1.0f / 2.0f;
		static constexpr double mutateFieldGeneGaussKernelGlobalAmplitudeProbability	= 0.0f;
		// field gene mexican hat kernel mutation probabilities (sum must be 1.0)
		static constexpr double mutateFieldGeneMexicanHatKernelAmplitudeExcProbability		= 1.0f / 4.0f;
		static constexpr double mutateFieldGeneMexicanHatKernelAmplitudeInhProbability		= 1.0f / 4.0f;
		static constexpr double mutateFieldGeneMexicanHatKernelWidthExcProbability			= 1.0f / 4.0f;
		static constexpr double mutateFieldGeneMexicanHatKernelWidthInhProbability			= 1.0f / 4.0f;
		static constexpr double mutateFieldGeneMexicanHatKernelGlobalAmplitudeProbability	= 0.0f;
