...
namespace neat_dnfs
{
	...
	struct GaussKernelConstants
	{
		...
		static constexpr double amplitude = 20;
	...
	struct CompatibilityCoefficients
	{
		...
		static constexpr double averageConnectionDifferenceCompatibilityWeight = 0.5; //0.5

		static constexpr double amplitudeDifferenceCoefficient = 1.0;
		static constexpr double widthDifferenceCoefficient = 1.0;
	};
	...
	struct PopulationConstants
	{
		...
		static constexpr double pruneRatio = 0.1;
