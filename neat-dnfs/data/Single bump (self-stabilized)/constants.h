...
namespace neat_dnfs
{
	...
	struct NeuralFieldConstants
	{
		...
		static constexpr double restingLevelStep	= 0.25;
	};
	...
	struct GaussKernelConstants
	{
		...
		static constexpr double widthMaxVal		= 25.0; //25 // 5.0 // 50
	...
	struct MexicanHatKernelConstants
	{
		...
		static constexpr double widthExcMaxVal	= 20.0; // 9.0 // 50
		...
		static constexpr double ampExcMaxVal	= 35.0; // 25.0 //85
